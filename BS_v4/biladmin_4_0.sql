...
CREATE OR replace DIRECTORY ACCOUNT_DIR AS 'D:\accounting';
CREATE OR replace DIRECTORY BANK_DIR AS 'D:\bank';
CREATE OR replace DIRECTORY OPER_OUT_DIR AS 'D:\operator_out';
CREATE OR replace DIRECTORY RAPORT_DIR AS 'D:\raport';
GRANT READ, WRITE ON DIRECTORY oper_dir TO BILADMIN;
GRANT READ, WRITE ON DIRECTORY trash_dir TO BILADMIN;
GRANT READ, WRITE ON DIRECTORY account_dir TO BILADMIN;
GRANT READ, WRITE ON DIRECTORY bank_dir TO BILADMIN;
GRANT READ, WRITE ON DIRECTORY oper_out_dir TO BILADMIN;
GRANT READ, WRITE ON DIRECTORY raport_dir TO BILADMIN;
