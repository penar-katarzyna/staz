...
V_USLUGA := dodaj_usluga(3,null,'pakiet 600 sms',600,1,'1-sty-2014 00:00:00','1-lis-2014 00:00:00',5,null,null,'30 00:00:00','90 00:00:00',null,null,10,null);
V_USLUGA2 := dodaj_usluga(3,null,'pakiet 100 sms',100,1,'1-sty-2014 00:00:00','1-lis-2014 00:00:00',1.2,null,null,'30 00:00:00','90 00:00:00',null,null,10,null);
V_USLUGA3 := dodaj_usluga(null,null,'konto 60',60,1,'1-lis-2014 00:00:00','1-lis-2015 00:00:00',0,null,null,null,null,'0-1',null,0,null);
V_USLUGA4 := dodaj_usluga(null,null,'konto 30',30,1,'1-lis-2014 00:00:00','1-lis-2015 00:00:00',0,null,null,null,null,'0-1',null,0,null);
V_USLUGA5 := dodaj_usluga(1,null,'pakiet 60 minut',600,1,'8-lip-2014 14:54:35','12-lip-2014 14:54:35',12,null,null,'30 00:00:00','90 00:00:00',null,null,10,null);
V_USLUGA6 := dodaj_usluga(1,null,'pakiet weekend',1,1,'8-lip-2014 14:54:35','12-lip-2014 14:54:35',12,null,null,'2 00:00:00','2 00:00:00',null,null,10,null);
...
V_TARYFA := dodaj_taryfa('ABONAMENT 30','1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA2,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA4,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA5,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');

for c in (select IDENTYFIKATOR from W_KOD where NAZWA_REGIONU='MALOPOLSKIE') loop
V_PRZYPIS := PRZYPISZ_TARYFA_DO_KOD(V_TARYFA,c.IDENTYFIKATOR,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
end loop;


for c in (select IDENTYFIKATOR from W_KOD where NAZWA_REGIONU='ŁÓDZKIE') loop
V_PRZYPIS := PRZYPISZ_TARYFA_DO_KOD(V_TARYFA,c.IDENTYFIKATOR,'1-sty-2014 00:00:00','1-lis-2014 00:00:00');
end loop;

--
V_TARYFA := dodaj_taryfa('ABONAMENT 60','1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA3,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA4,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
V_PRZYPIS := PRZYPISZ_USLUGA_DO_TARYFA(V_USLUGA5,V_TARYFA,'1-lis-2013 00:00:00','1-lis-2014 00:00:00');
...
V_TARYFA := dodaj_taryfa('ZAWSZE',null,'12-lip-2016 14:54:35');
...
CREATE OR REPLACE PROCEDURE F_IDENTYFIKATORY
   IS
   V_IDENTYFIKATOR number;
   V_TYP_U NUMBER;
	V_PREF number;
	v_numer number;
BEGIN
...
v_numer:='666';
V_PREF:=DODAJ_PREFIX('0);
V_TYP_U:=dodaj_typ_urzadzenia('TELEFON KOMÓRKOWY');
for i in 0..5
loop
V_IDENTYFIKATOR := dodaj_identyfikator('0048'||i||'000',V_TYP_U,0,v_pref);
