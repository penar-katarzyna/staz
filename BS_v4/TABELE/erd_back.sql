...
CREATE TABLE kraj_kraj (
  ...
  data_do TIMESTAMP    ,
  data_od TIMESTAMP    ,
  c_rozmowa_in NUMBER(19,4)    ,
  c_rozmowa_out NUMBER(19,4)    ,
  c_sms_in NUMBER    ,
  c_sms_out NUMBER    ,
  c_mms_in NUMBER    ,
  c_mms_out NUMBER    ,
...
CREATE TABLE faktura (
  id NUMERIC   NOT NULL ,
  klient__id NUMERIC   NOT NULL ,
  szablon_faktury__id NUMERIC   NOT NULL ,
...
CREATE TABLE zdarzenie (
  id NUMERIC   NOT NULL ,
  usluga_klienta__id NUMERIC   NOT NULL ,
  typ_zdarzenia__id NUMERIC   NOT NULL ,
  identyfikator__id NUMERIC   NOT NULL ,
  prefix__id NUMERIC    ,
